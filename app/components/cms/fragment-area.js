...
export default Ember.Component.extend({
  ...
  //   var currentFragment = this.get("pwbPage.details.fragments")[this.cmsPartInfo.label][this.get("locale")];
  //   if (currentFragment && currentFragment.html) {
  //     return currentFragment.html;
  //   } else {
  //     return "";
  //   }
  // }.property("pwbPage"),
  ...
  setupComponent: function() {
    ...
    var currentFragment = this.get("pwbPage.details.fragments")[this.cmsPartInfo.label][this.get("locale")];
    if (currentFragment && currentFragment.html) {
      fragmentHtml.content = currentFragment.html;
    } 
